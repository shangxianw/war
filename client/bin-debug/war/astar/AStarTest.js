    ...
    var AStarTest = (function (_super) {
        ...
        AStarTest.prototype.OnTap = function (e) {
            ...
            for (var _i = 0, path_1 = path; _i < path_1.length; _i++) {
                var node = path_1[_i];
                var x_1 = node.x * this.space + (this.space >> 1);
                var y_1 = node.y * this.space + (this.space >> 1);
                this.pathShap.graphics.lineTo(x_1, y_1);
                this.nodeShap.graphics.drawCircle(x_1, y_1, 5);
            }
